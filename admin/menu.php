...
<ol>
	<li>
		<a href="../index.php" target="main"><b><?php echo $MSG_SEEOJ?></b></a>
...
-->
<?php if (isset($_SESSION['administrator'])){ //吴传夏学长加的功能.导入用户.
?><li>
	<a href="xx_importUsers.php" target="main"><b><?php echo $MSG_IMPORT.$MSG_USERS?></b></a>
<?php }
?>
</ol>
