...
//if ($pid>25) $pid=25;even修改，还是题目ID的关系.
//echo "pid is ".$cid."<br>";
...
?>
Problem <a href = "problem.php?cid=<?php echo $cid;?>&pid=<?php echo $pid;?>"><span class=blue><b>
<?php if ($problem_rows<=25) echo $PID[$pid];else echo $pid;?></b></span></a> of Contest <a href = "contest.php?cid=<?php echo $cid;?>"> <span class=blue><b><?php echo $row->title?></b></span></a><br>
<input id="cid" type='hidden' value='<?php echo $cid?>' name="cid">
<input id="pid" type='hidden' value='<?php echo $pid?>' name="pid">
<?php }?>
<?phpmysql_free_result($result1); ?>
Language:
...
<?php
//	echo "lang_count:".$lang_count."<br>";	 
//	echo "langmask:".$langmask;	
?>
<br>
